...
namespace LibuvSharp
{
	...
	{
		[DllImport(PlatformApis.LIBUV, EntryPoint = "uv_fileno", CallingConvention = CallingConvention.Cdecl)]
		...
		[DllImport(PlatformApis.LIBUV, EntryPoint = "uv_tcp_open", CallingConvention = CallingConvention.Cdecl)]
		...
		[DllImport(PlatformApis.LIBUV, EntryPoint = "uv_udp_open", CallingConvention = CallingConvention.Cdecl)]
