...
namespace Libuv
{
	...
	public class File
	{
		...
		public void Send(Loop loop, Tcp tcp, int offset, int length, Action<Exception, int> callback)
		{
			var fsr = new FileSystemRequest();
		...
		public void Send(Tcp tcp, int offset, int length, Action<Exception, int> callback)
		{
